...
data class TrackStringsState(
    override val fabText: Int = R.string.db_manager_fab_text_track,
    override val emptyDatabase: Int = R.string.db_manager_empty_track,
    override val searchPlaceHolder: Int = R.string.db_manager_search_placeholder_track
) : ContentStringsState()
