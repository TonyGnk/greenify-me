...
enum class DBManagerNavDestination { Account, Record, Track, Material }
...
data class NavScreenState(
    ...
    val navigationList: List<DBManagerNavItem> = DBManagerNavDestination.entries.map {
        when (it) {
            ...
            DBManagerNavDestination.Track -> DBManagerNavItem(
                destination = DBManagerNavDestination.Track,
