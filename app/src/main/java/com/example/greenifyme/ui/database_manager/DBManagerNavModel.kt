...
enum class NavDestination { Account, Material, TrackedMaterial, Track }
...
private var savedDestination: NavDestination? = null
...
data class NavScreenState(
    ...
    val destination: NavDestination = savedDestination ?: NavDestination.Account,
